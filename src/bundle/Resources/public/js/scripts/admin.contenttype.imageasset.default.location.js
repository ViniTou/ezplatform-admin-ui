(function (global, doc, React, ReactDOM) {
    const btns = doc.querySelectorAll('.btn--udw-imageasset-default-location');
    ...
    const onConfirm = (btn, items) => {
        ...
        const objectRelationListSettingsWrapper = btn.closest('.ezimageasset-settings');
        const objectRelationSettingsWrapper = btn.closest('.ezimageasset-settings');
